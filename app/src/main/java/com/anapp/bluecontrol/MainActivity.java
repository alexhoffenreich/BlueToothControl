...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        send_text_button = (Button) findViewById(R.id.send_text_button);


        send_text_button.setEnabled(false);

        btAdapter = BluetoothAdapter.getDefaultAdapter();

        checkBTState();
        // Auto connection to HC-06
   /* Set<BluetoothDevice> pairedDevices = btAdapter.getBondedDevices();
    ...
    public void connectToDevice(String adr) {
        ...
        send_text_button.setEnabled(true);
...
//  }
    ...
    public void sendText(View view) {
        sendData(text_to_send.getText().toString() + "\n");
